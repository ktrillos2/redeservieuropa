      ...
      fields: [
          ...
          fields: [
            ...
            defineField({
              ...
              fields: [
                ...
                { name: 'circuitName', title: 'Circuit Name', type: 'string' },
              ],
            }),
          ],
        }),
        ...
        defineField({
          ...
          fields: [
            ...
            defineField({
              name: 'amenities',
              title: 'Commodités du véhicule',
              type: 'array',
              of: [{ type: 'string' }],
            }),
            defineField({
              name: 'overCapacityNote',
              title: 'Note de surcapacité',
              type: 'string',
            }),
            defineField({
              name: 'route',
              ...
              type: 'object',
              fields: [
                { name: 'origin', title: 'Origine', type: 'string' },
                { name: 'destination', title: 'Destination', type: 'string' },
                { name: 'circuitName', title: 'Nom du circuit', type: 'string' },
              ],
            }),
          ],
        }),
